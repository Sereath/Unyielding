...
GunStats.setWeaponStat("boltaction","DAMAGE",25.0);
GunStats.setWeaponStat("boltaction","DAMAGE_MIN",15.0);

GunStats.setWeaponStat("flamethrower","DAMAGE",7.0);
GunStats.setWeaponStat("flamethrower","DAMAGE_MIN",3.5);

GunStats.setWeaponStat("rocketlauncher","DAMAGE",50.0);
GunStats.setWeaponStat("rocketlauncher","DAMAGE_MIN",50.0);
...
GunStats.setWeaponStat("nucleardeathray","DAMAGE",9.0);
GunStats.setWeaponStat("nucleardeathray","DAMAGE_MIN",9.0);

GunStats.setWeaponStat("tfg","DAMAGE",144.0);
GunStats.setWeaponStat("tfg","DAMAGE_MIN",144.0);
